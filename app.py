...
def get_posts(category, page=1, per_page=6):
    ...
    total = int(total_str) if total_str.isdigit() else len(pinned)

    # Обычные посты (пагинация)
